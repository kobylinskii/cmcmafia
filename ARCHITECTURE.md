...
У чёрных ролей ЛХ в зачёт не идёт (`Nomination.with_lh`). Вместе с победителем
отдаётся его статистика **именно в зачёте номинации** — игры, победы,
поражения, % побед, судейские и ЛХ на этой роли (у MVP и мест — по всему
финальному столу). Равные значения разводит место в турнирной таблице, то есть
тай-брейк из 7.6.
