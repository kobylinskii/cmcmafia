...
# ни от кого не требуется. Так и задумано: два бота с одним токеном начинают
# выхватывать апдейты друг у друга, поэтому поднимать его стоит осознанно и
# отдельной командой, убедившись, что другой экземпляр нигде не работает.
