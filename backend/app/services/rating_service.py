...
def describe_formula():
    ...
    return RatingFormulaOut(
        intro="Система Эло, как в шахматах, адаптированная под правила клуба.",
        ...
        "от которого зависит K. В личной статистике игрока они тоже не учитываются: "
        "ни в счётчиках игр и побед, ни в разбивке по картам и ролям, ни в средних баллах.",
    )
