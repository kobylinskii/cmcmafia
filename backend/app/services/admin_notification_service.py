...
Получатели -- админы сайта с привязанным Telegram: заявки и правки разбирают
именно они, на вкладке «Обзор». Админ сайта без telegram_id в рассылку не
попадает (писать некуда), бот-админ без прав на сайте -- тоже (делать с
оповещением ему нечего).
"""
