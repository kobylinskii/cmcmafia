...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-36 right-[-10%] h-[580px] w-[600px] rounded-full bg-brand-600/32 blur-[125px]"
      />
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8">
        <div className="relative z-10 flex flex-col items-start gap-6">
          ...
          <p className="max-w-md text-base leading-relaxed text-ink-300 md:text-lg">
            Результаты проведённых игр, рейтинг Эло, профили игроков.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
          <div
            aria-hidden
            className="absolute inset-0 -z-10 scale-90 rounded-full bg-brand-600/30 blur-[100px]"
          />
